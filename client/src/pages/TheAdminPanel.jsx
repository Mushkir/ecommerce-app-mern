...
const TheAdminPanel = () => {
  ...
  return (
    <div className="font-Sen flex">
      <aside className=" bg-white w-full max-w-60 p-5 min-h-screen shadow-xl">
        <div className="flex flex-col items-center justify-center mt-14">
          {currentUser ? (
            <img
              src={currentUser?.profilePic?.url}
              alt={`${currentUser?.name}'s picture`}
